...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    Answer: 
    My name is **Dana Thacker** and I am majoring in *Data Science*. I am 20 years old and I am from Johnston, Iowa. I have three sisters, two older and one younger. I enjoy playing soccer, clarinet, and running. I like traveling, especially if it is a roadtrip. I have been out of the country once when I went to Guatemala on a missions trip. I am in the varsity football marching band at Iowa State and I am also involved in the Salt Company.
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Answer: 
    One job related to data science is a data architect. Data architects are generally responsible for visualizing and designing the data management framework for organizations. They refine and structure the data so that it is easier for others to comprehend and deal with. Data architects improve data systems.
    [Data Architect](https://dv-website.s3.amazonaws.com/uploads/2019/03/pg_davsde_031919.jpg)
   ![Data Architect](DataArchitect2.png)
   
5. What data topic will you be most interested in? (Optional) Provide a source of such dataset if you have.

    Answer: 
    I am quite interested in healthcare and general US population data. I don't have any specific datasets in mind.
...
6. To check that your R and Rstudio installation is correct, find the version of R by entering `version` into the R console. Include this command into a R code trunk in your solution `Rmd` file to have it automatically printed in the knitted html file. 
    ...
    Answer: 
    I have R version 4.0.3 (2020-10-10)
    ```{R}
    version
    ```    
...
<!-- Then explore the bash command line and Git. -->
    ...
    Answer: 
    I have git version 2.24.3 (Apple Git-128).
